...
export const HTML_SECURITY_HEADERS: Record<string, string> = {
  ...
  'Content-Security-Policy': [
    ...
    // .js file. style-src keeps 'unsafe-inline' because the dashboard's
    // rendered markup uses inline style="…" attributes throughout
    // app.js's templates (and the theme-preload bootstrap may set one).
    "script-src 'self'",
